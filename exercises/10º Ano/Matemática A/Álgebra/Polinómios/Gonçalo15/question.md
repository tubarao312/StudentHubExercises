## Decompõe $ A(x) = 3x^{3} + x^{2}-12x -4 $ num produto de dois fatores, sabendo que 2 é uma raiz de A(x) e o quociente é $ Q(x) = 3x^{2}+7x+2 $ e resolve a equação A(x) = 0 para encontrares o valores de x. 
